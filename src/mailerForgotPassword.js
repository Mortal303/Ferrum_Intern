...
export default {
    resetPassword: (data, url) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            try {
                const filePath = path.join(path.dirname(require.main.filename), 'web', 'resources', 'views', 'emailTemplates', 'forgotPassword.html');

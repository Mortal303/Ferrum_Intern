export default {
    ...
    /**
     * Call apis from this url
     */
    apiUrl_primary: process.env.API_URL1 || "http://localhost:3000",
    apiUrl_secondary: process.env.API_URL2 || "http://localhost:3000",
    ...
    /**
     * Go Api for emailVerify
     *
     * razorPay id and secret
     */
    razorPayId: process.env.RAZOR_ID || "",
